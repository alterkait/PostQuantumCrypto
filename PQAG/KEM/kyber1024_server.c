...
unsigned char ctxt[pqcrypto_kem_kyber1024_CIPHERTEXTBYTES];
unsigned char ss[pqcrypto_kem_kyber1024_BYTES];
...
int main(){
        ...
        start_time = clock();
        pqcrypto_kem_kyber1024_keypair(pk, sk);
        end_time = clock();
        ...
        start_time = clock();
        start_cycles = rdtsc();
        pqcrypto_kem_kyber1024_dec(ss, ctxt, sk);
        end_cycles = rdtsc();
