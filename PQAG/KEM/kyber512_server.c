...
#include "pqcrypto_kem_kyber512.h"
...
unsigned char pk[pqcrypto_kem_kyber512_PUBLICKEYBYTES];
unsigned char sk[pqcrypto_kem_kyber512_SECRETKEYBYTES];
unsigned char ctxt[pqcrypto_kem_kyber512_CIPHERTEXTBYTES];
unsigned char ss[pqcrypto_kem_kyber512_BYTES];
...
int main(){
        ...
        printf("Generating Kyber512 key pair...\n");
        start_time = clock();
        pqcrypto_kem_kyber512_keypair(pk, sk);
        end_time = clock();
        ...
        start_time = clock();
        start_cycles = rdtsc();
        pqcrypto_kem_kyber512_dec(ss, ctxt, sk);
        end_cycles = rdtsc();
        end_time = clock();
