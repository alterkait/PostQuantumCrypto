...
#include "pqcrypto_kem_mceliece6960119.h"
...
unsigned char pk[pqcrypto_kem_mceliece6960119_PUBLICKEYBYTES];
unsigned char sk[pqcrypto_kem_mceliece6960119_SECRETKEYBYTES];
unsigned char ctxt[pqcrypto_kem_mceliece6960119_CIPHERTEXTBYTES];
unsigned char ss[pqcrypto_kem_mceliece6960119_BYTES];
...
int main(){
        ...
        start_time = clock();
        pqcrypto_kem_mceliece6960119_keypair(pk, sk);
        end_time = clock();
        ...
        start_time = clock();
        start_cycles = rdtsc();
        pqcrypto_kem_mceliece6960119_dec(ss, ctxt, sk);
        end_cycles = rdtsc();
