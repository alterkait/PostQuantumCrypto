...
#include "pqcrypto_kem_mceliece8192128.h"
...
unsigned char pk[pqcrypto_kem_mceliece8192128_PUBLICKEYBYTES];
unsigned char sk[pqcrypto_kem_mceliece8192128_SECRETKEYBYTES];
unsigned char ctxt[pqcrypto_kem_mceliece8192128_CIPHERTEXTBYTES];
unsigned char ss[pqcrypto_kem_mceliece8192128_BYTES];
...
int main(){
        ...
        start_time = clock();
        pqcrypto_kem_mceliece8192128_keypair(pk, sk);
        end_time = clock();
        ...
        start_time = clock();
        start_cycles = rdtsc();
        pqcrypto_kem_mceliece8192128_dec(ss, ctxt, sk);
        end_cycles = rdtsc();
