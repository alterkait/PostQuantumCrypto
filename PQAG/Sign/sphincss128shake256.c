...
#include "pqcrypto_sign_sphincss128shake256.h"
...
unsigned char pk[pqcrypto_sign_sphincss128shake256_PUBLICKEYBYTES];
unsigned char sk[pqcrypto_sign_sphincss128shake256_SECRETKEYBYTES];
unsigned char message[] = "This is an Authenticated Payload, Signed 7633254";
unsigned char signed_message[pqcrypto_sign_sphincss128shake256_BYTES + sizeof(message)];
...
int main(){
        ...
        start_time = clock();
        pqcrypto_sign_sphincss128shake256_keypair(pk, sk);
        end_time = clock();
        ...
        start_time = clock();
        pqcrypto_sign_sphincss128shake256(signed_message, &signed_message_len, message, sizeof(message) - 1, sk);
        end_time = clock();
